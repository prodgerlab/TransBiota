...
# Especifica tu orden “prioritario”
desired_first <- c("Corynebacterium",   # 1.º
                   "Prevotella",        # 2.º
                   "Peptoniphilus")     # 3.º
# Reconstruye el vector: primero los deseados y luego el resto
top_taxa_order <- c(desired_first,
                    setdiff(top_taxa_order, desired_first))
...
svglite("Supp_Fig_9.svg", width=10, height=10) # Showing all CM samples
plot_PC
dev.off()
